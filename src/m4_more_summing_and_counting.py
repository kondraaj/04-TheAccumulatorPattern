...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 4
    answer = count_cosines_from(10, 14, 0)
    ...
    # Test 4:
    expected = 8
    answer = count_cosines_from(1, 15, -0.1)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 0
    answer = count_cosines_from(2, 3, 0.4)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 8
    answer = count_cosines_from(30, 47, 0.19)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 3.73429  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 23)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
